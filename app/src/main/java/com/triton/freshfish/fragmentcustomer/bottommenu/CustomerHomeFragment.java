package com.triton.freshfish.fragmentcustomer.bottommenu;
...
import com.triton.freshfish.activity.location.PickUpLocationAllowActivity;
import com.triton.freshfish.activity.location.PickUpLocationDenyActivity;
import com.triton.freshfish.adapter.PetLoverDashboardPubbyLoveAdapter;
import com.triton.freshfish.adapter.PetLoverDoctorNewAdapter;
import com.triton.freshfish.adapter.PetLoverServicesAdapter;
import com.triton.freshfish.adapter.PetLoverShopNewAdapter;
import com.triton.freshfish.adapter.ViewPagerDashboardAdapter;
...
import com.triton.freshfish.requestpojo.PetLoverDashboardRequest;
...
public class CustomerHomeFragment extends Fragment implements Serializable,
    ...
    private void showLocationAlert() {
        ...
        try {
            ...
            txt_lbl1.setText("Fresh fish would like to");
