package com.triton.freshfish.activity;
...
import com.triton.freshfish.doctor.DoctorMyOrdrersActivity;

import com.triton.freshfish.doctor.DoctorWalkinAppointmentsActivity;
import com.triton.freshfish.customer.CustomerDashboardActivity;
import com.triton.freshfish.customer.PetMyOrdrersNewActivity;
import com.triton.freshfish.customer.PetMyappointmentsActivity;
import com.triton.freshfish.customer.PetWalkinappointmentsActivity;
                ...
                if(user_type != null){
                    if(user_type.equalsIgnoreCase("1")){
                        ...
                        if(appintments != null && !appintments.isEmpty()){
                            ...
                            Intent intent = new Intent(SplashActivity.this, com.triton.freshfish.serviceprovider.shop.SPMyOrdrersActivity.class);
                            intent.putExtra("orders",orders);
                            startActivity(intent);
                            finish();
                        }else{
